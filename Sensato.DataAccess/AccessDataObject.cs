...
namespace Sensato.DataAccess
{
    public class DataAccessADO
    {
        ...
        public static DataTable GetDataTable(string storedProcedureOrQuery, CommandType type, List<SqlParameter> parameters = null, string connStr = null, SqlTransaction transaction = null)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(transaction.ToString()))
                    throw new DataAccessException(ErrorsAndExceptionsCatalog._610_Code, ErrorsAndExceptionsCatalog._610_InvalidSQLTransaction);
                else if (transaction.GetType().Name != "SqlTtransaction")
                    throw new DataAccessException(ErrorsAndExceptionsCatalog._609_Code, ErrorsAndExceptionsCatalog._609_SQLTransactionNotFound);
            ...
            {
                throw new DataAccessException(ErrorsAndExceptionsCatalog._616_Code, ErrorsAndExceptionsCatalog._616_InvalidDataTable);
            }
        }
        ...
        public static DataSet GetDataSet(string storedProcedureOrQuery, CommandType type, List<SqlParameter> parameters = null, string connStr = null, SqlTransaction transaction = null)
        {
            ...
            {
                throw new DataAccessException(ErrorsAndExceptionsCatalog._617_Code, ErrorsAndExceptionsCatalog._617_InvalidDataSet);
            }
        }
        ...
        public static bool ExecuteNonQuery(string storedProcedureOrQuery, CommandType type, List<SqlParameter> parameters = null, string connStr = null, SqlTransaction transaction = null)
        {
            ...
            {
                throw new DataAccessException(ErrorsAndExceptionsCatalog._618_Code, ErrorsAndExceptionsCatalog._618_InvalidSentenceExecution);
            }
        }
    }
}
